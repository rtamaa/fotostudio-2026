...
<div class="min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <button type="submit" class="w-full bg-pink-600 text-white py-2 rounded-lg">Login</button>
        </form>
        <p class="text-center mt-4">Belum punya akun? <a href="{{ route('register') }}" class="text-pink-600">Daftar</a></p>
    </div>
</div>
@endsection